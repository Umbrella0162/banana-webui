                        ...
                        <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    disabled={selectedImage.isTextOnly || zoom <= 0.5}
                                    title="缩小"
                                >
                                ...
                                <Button
                                    ...
                                    disabled={selectedImage.isTextOnly || (zoom === 1 && position.x === 0 && position.y === 0)}
                                    title="重置位置和缩放"
                                >
                                ...
                                <Button
                                    ...
                                    disabled={selectedImage.isTextOnly || zoom >= 3}
                                    title="放大"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <Button
                                    ...
                                    disabled={selectedImage.isTextOnly}
                                    title="下载"
                                >
